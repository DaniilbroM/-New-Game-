...
<!-- Reset Button - Small circle top left -->
<button class="reset-btn" id="resetGameBtn" style="position: fixed; top: 15px; left: 15px; width: 30px; height: 30px; border-radius: 50%; background: rgba(255,50,50,0.7); color: white; border: none; cursor: pointer; z-index: 10001; font-size: 16px;">
    ⟳</button>
