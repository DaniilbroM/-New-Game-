...
<nav class="top">
  ...
  <div class="top-status hidden">
    ...
    <span class="level">Lvl <strong class="level-count">1</strong></span>
  </div>
  <nav class="popout">
...
<div class="gameStartOverlay">
    <div class="gameStartPanel">
        ...
        <div class="village-typewrap" aria-hidden="false">
            ...
            <p class="village-typewriter">Hello Adventurer, Your Goals is to Defeat the Demon Lord</p>
